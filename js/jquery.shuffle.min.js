...
(function (factory) {
  ...
  // Constants
  var CAN_TRANSITION_TRANSFORMS =
    Modernizr.csstransforms && Modernizr.csstransitions;
  ...
  Shuffle.prototype._initItems = function ($items) {
    ...
    $items.addClass(
      [Shuffle.ClassName.SHUFFLE_ITEM, Shuffle.ClassName.FILTERED].join(" ")
    );
    $items
      .css(this.itemCss)
  ...
  Shuffle.prototype._setSequentialDelay = function ($collection) {
    ...
    each(
      ...
      function (el, i) {
        ...
        el.style[TRANSITION_DELAY] =
          "0ms," + (i + 1) * this.sequentialFadeDelay + "ms";
      },
      this
    );
  };
  ...
  Shuffle.prototype._setColumns = function (theContainerWidth) {
    var containerWidth =
      theContainerWidth || Shuffle._getOuterWidth(this.element);
  ...
  Shuffle.prototype._getItemPosition = function (itemSize) {
    var columnSpan = this._getColumnSpan(
      itemSize.width,
      this.colWidth,
      this.cols
    );
   ...
   * @private
   */
  Shuffle.prototype._getColumnSpan = function (
    itemWidth,
    columnWidth,
    columns
  ) {
  ...
  Shuffle.prototype._getStylesForTransition = function (opts) {
    ...
    if (this.supported) {
      styles[TRANSFORM] = Shuffle._getItemTransformString(
        opts.point,
        opts.scale
      );
    } else {
  ...
  Shuffle.prototype._startItemAnimation = function (
    $item,
    styles,
    callfront,
    callback
    ...
    if (this.supported) {
      ...
      var anim = $item
        .stop(true)
        .animate(styles, this.speed, "swing", callback);
   ...
   * @private
   */
  Shuffle.prototype._whenCollectionDone = function (
    $collection,
    eventName,
    callback
  ) {
  ...
  Shuffle.prototype._whenAnimationsDone = function (callback) {
    $.when.apply(null, this._animations).always(
      $.proxy(function () {
  ...
  Shuffle.prototype.remove = function ($collection) {
    ...
    this.$el.one(
      Shuffle.EventType.LAYOUT + "." + SHUFFLE,
      $.proxy(handleRemoved, this)
    );
  };
